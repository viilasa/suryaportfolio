...
import type { FeaturedProject as FeaturedProjectType, ProjectEntry, ClientWork } from '../types';

const FeaturedProject = ({ project }: { project: FeaturedProjectType }) => (
    <a
        href={project.link}
        target="_blank"
...
const ClientWorkCard = ({ client, index }: { client: ClientWork; index: number }) => (
    <a
        href={client.link}
        target="_blank"
        rel="noopener noreferrer"
